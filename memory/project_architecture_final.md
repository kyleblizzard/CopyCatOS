...
- **Window manager:** cc-wm (C + Xlib + Cairo + Pango). Reparenting compositing WM with EWMH.
- **Shell:** Four standalone C programs — cc-dock, cc-menubar, cc-desktop, cc-spotlight.
...
**Why custom WM over kwin:** Total control over window chrome, shadows, animations. No dependency on KDE Frameworks for the shell. KDecoration2 was replaced by direct Cairo rendering in cc-wm.

...
// CopyCatAppKit.h — MoonBase core public API (Phase A spec, declarations only).
//
// Public framework name: CopyCatAppKit.framework (install-layout pending).
// Legacy include path <moonbase.h> remains valid during soft transition —
// it's a thin shim that includes this header.
//
...
#ifndef COPYCATAPPKIT_H
#define COPYCATAPPKIT_H

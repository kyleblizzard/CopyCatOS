...
//
// Public framework name: MoonBase.framework. Bundle layout is
// MoonBase.framework/{Headers/moonbase.h, Versions/A/MoonBase}, where
// the versioned binary is the installed libmoonbase.so.1. The framework
// install-layout is a follow-up slice.
//

...
//
// This is the central struct that holds all state for an AuraFinder window.
...
//
// AuraFinder is a standalone C + Xlib + Cairo + Pango application.
// It does NOT use Qt — it creates its own window, and aura-wm frames

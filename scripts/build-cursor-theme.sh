...
static_defs = [
    ("left_ptr",            "arrow",            16, 21, 1,  1),
    ("context_menu",        "contextual_menu",  25, 37, 1,  1),
    ("copy",                "copy_arrow",       25, 36, 1,  1),
    ("xterm",               "ibeam",            31, 37, 15, 18),
    ("crosshair",           "crosshair_0",      32, 32, 16, 16),
    ("cell",                "plus_0",           32, 32, 16, 16),
    ("hand2",               "pointing_hand",    16, 16, 6,  1),
    ("openhand",            "open_hand",        16, 16, 8,  8),
    ("closedhand",          "closed_hand_0",    64, 64, 32, 32),
    ("not-allowed",         "not_allowed",      16, 16, 8,  8),
    ("pirate",              "poof",             16, 16, 8,  8),
    ("dnd-link",            "drag_link",        40, 40, 10, 5),
    ("left_side",           "resize_left",      16, 16, 8,  8),
    ("right_side",          "resize_right",     16, 16, 8,  8),
    ("sb_h_double_arrow",   "resize_left_right",16, 16, 8,  8),
    ("top_side",            "resize_up",        16, 16, 8,  8),
    ("bottom_side",         "resize_down",      16, 16, 8,  8),
    ("sb_v_double_arrow",   "resize_up_down",   16, 16, 8,  8),

...
// whether a stack entry should be handed to moonbase-launch or opened
// with xdg-open. Name kept as stacks_path_is_appc_bundle because the
// metadata file it checks for is Info.appc, not a reference to the
